...
public class BP1_M2_PostTest2_Wira_Applet3D extends Applet 
    implements MouseListener, MouseMotionListener {
    
    int width, height;
    int mx, my; // the most recently recorded mpuse coordinates
    ...
    void drawWireframe(Graphics g) {
        //compute coefficient for the projection
        ...
        for(j=0; j<vertices.length; j++){
            ...
            float y1 = -sinTcosP*x0 + cosP*y0 + cosTsinP*z0;
            
            //now adjust things to get a persepective projection
